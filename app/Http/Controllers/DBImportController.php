...
class DBImportController extends Controller
{
    ...
    (1, 'SUPERADMINISTRADOR', 777, '2020-03-18 05:00:00', '2020-03-18 05:00:00'),
    (2, 'ADMINISTRADOR', 777, '2020-03-18 05:00:00', '2020-03-18 05:00:00'),
    (3, 'GENERAL', 755, '2020-03-18 05:00:00', '2020-03-18 05:00:00')");
    }
    ...
    (1, 'ADMIN', 'admin@admin.com', 1, 1, NULL, '$2y$10"."$"."WxY22RZzYx1Y91H5ib9CjOJ9A8dNQSVWzYpOqDmoFV1FtzABiJx9a', NULL, '2020-03-19 04:48:01', '2020-03-19 04:48:01'),
    (2, 'Jorge Sánchez', 'jorgesanchez@gmail.com', 3, 1,NULL, '$2y$10"."$"."hs.DFhsLj62Rtu5SGNu5au5/nahpmLXPpf980D6vjrpixRHlFjcw2', NULL, '2020-03-19 04:49:17', '2020-03-19 04:49:17')");
...
(4, 'OTRO', '2020-03-18 05:00:00', '2020-03-18 05:00:00')
    ...
    public function insertPosts(){
        DB::insert("
    INSERT INTO posts (id, title, date_time, type, card_type, description, content, user_id,category_id, file_id, created_at, updated_at) VALUES
(1, 'BIENVENIDO A MI WEB', '2020-03-18 00:00:00', 'CENTERED', 'NORMAL', 'Descripción', '<div class=\"post-top-area\"><p class=\"para\">Esto es un texto de prueba gaaaaa</p></div><div class=\"post-image\"><img src=\"images/blog-1-1000x600.jpg\" alt=\"Blog Image\"></div><div class=\"post-bottom-area\"><p class=\"para\">Más texto de prueba</p></div>',1, 1, 1, '2020-03-18 05:00:00', '2020-03-18 05:00:00'),
(2, 'HOLA', '2020-03-18 00:00:00', 'SIDEBAR', 'TINY', 'Descripción','<p class=\"para\">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore etdolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip exea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiatnulla pariatur. Excepteur sintoccaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p><div class=\"post-image\"><img src=\"images/blog-1-1000x600.jpg\" alt=\"Blog Image\"></div>',1, 1, 1, '2020-03-18 05:00:00', '2020-03-18 05:00:00'),
(3, 'TÍTULO PRUEBA', '2020-03-18 00:00:00', 'LANDING', 'BIG', 'Descripción','<p class=\"para\">Texto de pruebas</p><div class=\"post-image\"><img src=\"images/blog-1-1000x600.jpg\" alt=\"Blog Image\"></div>',1, 1, 1, '2020-03-18 05:00:00', '2020-03-18 05:00:00'),
(4, 'AJÁ', '2020-03-18 00:00:00', 'CENTERED', 'BIG','Descripción', '<div class=\"post-top-area\"><p class=\"para\">Esto es una demo de un post.</p></div>',1, 1, 1, '2020-03-18 05:00:00', '2020-03-18 05:00:00'),
(5, 'BIENVENIDO POR SEGUNDA VEZ', '2020-03-18 00:00:00', 'CENTERED', 'TINY','Descripción', '<div class=\"post-top-area\"><p class=\"para\">Esto es una segunda demo de un post.</p></div>',1, 1, 1, '2020-03-18 05:00:00', '2020-03-18 05:00:00')
");
    }
...
(1, 'AVATAR', 'JPG', '/files-storage/images/avatar-default.jpg', 'IMAGEN', '2020-03-18 05:00:00', '2020-03-18 05:00:00'),
(2, 'VALLE', 'PNG', '/files-storage/images/image_1.jpg', 'IMAGEN', '2020-03-18 05:00:00', '2020-03-18 05:00:00')
